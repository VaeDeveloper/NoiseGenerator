...
#include <functional>
#include "Noise/NoiseGenerator.h" // или нужный тебе заголовок
...
TEST(StupidNoiseTest, HandlesInvalidParamsGracefully)
{
    float* result = nullptr;

    // invalid resolution or frequency (freq=0)
    EXPECT_THROW({
        result = StupidNoise2D(16, 0, nullptr, 1.0f, 123);
    }, std::runtime_error);
}
