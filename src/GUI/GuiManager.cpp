...
void GuiManager::DrawUI()
{
	...
	if(ImGui::BeginMenuBar())
	{
		...
		{
			if(ImGui::MenuItem("New")) { Logger::Log("New file created"); }
			if(ImGui::MenuItem("Open", "Ctrl+O")) { Logger::Log("Open clicked"); }
			if(ImGui::MenuItem("Save", "Ctrl+S")) { Logger::Log("Save clicked"); }
			ImGui::Separator();
		...
		if(ImGui::BeginMenu("View"))
		{
			...
			ImGui::MenuItem("Noise Preview", nullptr, &showPreview);
			ImGui::MenuItem("Output Log", nullptr, &showLog);
			ImGui::EndMenu();
		}
